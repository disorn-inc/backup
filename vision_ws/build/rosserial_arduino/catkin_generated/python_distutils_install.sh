...
echo_and_run cd "/home/mycoss/vision_ws/src/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/mycoss/vision_ws/src/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/mycoss/vision_ws/build/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
