...
echo_and_run cd "/home/mycoss/vision_ws/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/mycoss/vision_ws/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/mycoss/vision_ws/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
