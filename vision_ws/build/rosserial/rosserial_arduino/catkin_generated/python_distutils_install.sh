...
echo_and_run cd "/home/mycoss/vision_ws/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/mycoss/vision_ws/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/mycoss/vision_ws/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
